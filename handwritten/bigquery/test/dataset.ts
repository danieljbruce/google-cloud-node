...
describe('BigQuery/Dataset', () => {
  ...
  describe('createTable', () => {
    ...
    it('should create a table', done => {
      ...
      ds.createTable(TABLE_ID, options, (err: Error) => { if (err) done(err); });
    });
    ...
    it('should create a table on a different project', done => {
      ...
      table.create(options, (err: Error) => { if (err) done(err); });
    });
    ...
    it('should format the metadata', done => {
      ...
      ds.createTable(TABLE_ID, fakeOptions, (err: Error) => { if (err) done(err); });
    });
    ...
    it('should create a schema object from a string', done => {
      ...
      ds.createTable(TABLE_ID, {schema: SCHEMA_STRING}, (err: Error) => { if (err) done(err); });
    });
    ...
    it('should pass the location to the Table', done => {
      ...
      ds.createTable(TABLE_ID, {schema: SCHEMA_OBJECT}, (err: Error) => { if (err) done(err); });
    });
  ...
  describe('delete', () => {
    it('should delete the dataset via the api', done => {
      ...
      ds.delete((err: Error) => { if (err) done(err); });
    });
    ...
    it('should allow a force delete', done => {
      ...
      ds.delete({force: true}, (err: Error) => { if (err) done(err); });
    });
  ...
  describe('getModels', () => {
    it('should get models from the api', done => {
      ...
      ds.getModels((err: Error) => { if (err) done(err); });
    });
    ...
    it('should accept a query', done => {
      ...
      ds.getModels(query, (err: Error) => { if (err) done(err); });
    });
      ...
      it('should return Model & apiResponse', done => {
        ds.getModels(
          (
            ...
            expect(model instanceof _root.Model).toBeTruthy();
  ...
  describe('getTables', () => {
    it('should get tables from the api', done => {
      ...
      ds.getTables((err: Error) => { if (err) done(err); });
    });
    ...
    it('should accept a query', done => {
      ...
      ds.getTables(query, (err: Error) => { if (err) done(err); });
    });
